...
public class AstroImageProcessorActionListeners implements ActionListener, ChangeListener, ComponentListener, MouseListener
{
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		if (actionString.equals("MoveUpButton")) 		gui.plotAlignedImages( 0, 1);
		if (actionString.equals("MoveDownButton")) 		gui.plotAlignedImages( 0,-1);
		if (actionString.equals("MoveLeftButton")) 		gui.plotAlignedImages(-1, 0);
		if (actionString.equals("MoveRightButton")) 	gui.plotAlignedImages( 1, 0);
	...
	public void mouseClicked(MouseEvent arg0) {
		if (actionString.equals("mouseClickedOnImage")) gui.mouseClickedOnBWImage(arg0);
	}
